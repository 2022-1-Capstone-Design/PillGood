  ...
  return (
    ...
    <div className="main">
      ...
      <div className="main__intro">
        ...
        <div className="main__intro__main">
          <h2>약국에 방문하지 않아도, 검색을 하지 않아도 내 손 안의
            헬스케어 전문 서비스   PillGood
          </h2>
        </div>
        <p>
          PillGood은 개인별 최적화된 영양제 맞춤 서비스를 제공합니다. <br/>
          안심하고 믿을 수 있는 영양제 조회로 쉽고 빠르게 건강관리를 시작하세요.
        </p>
        <Link to="/form">
          <input className="startForm" type="submit" 
    ...
    <div className="secondpage">
      ...
      <div className="secondpage__left">
         ...
         <h4>
        PillGood이 제공하는 기능은 영양제 제안 시스템을 효과적으로 발휘합니다.<br/> 
        </h4>
      </div>
    ...
    <div className="thirdpage">
      ...
      <div className="thirdpage__">
          <div className="thirdpage__first">
              ...
              <h2>빠른 설문진단</h2>
              <p>
                겪고있는 증상을 체크해 영양소를 선별합니다.<br/>
                신체발달에 도움을 주는 영양소를 선정합니다.<br/>   
                10가지 문항을 종합/평가해 웰빙 서비스를 제안합니다.<br/>
              </p>
              </div>
          </div>
          <div className="thirdpage__second ">
              ...
              <div className="text2">
                  <h2>영양 헬스케어</h2>
                 <p>
                 여러 제약회사의 영양제를 알맞게 추천합니다.<br/>
                  영양소뿐만 아니라, 올바른 식습관을 관리합니다.  <br/>     
                  치우치지 않은 균형잡힌 건강관리를 돕습니다.<br/>
                </p> 
              </div>    
          </div> 
       </div> 
